        ...
        <v-layout row wrap>
          <v-flex xs6>
                ...
                <v-list-tile-content>
                  <v-list-tile-text>
                    <v-chip close outline>
                      ...
                      <v-avatar class="gray darken-4"><v-icon>check_circle</v-icon></v-avatar>{{ player_h.first_name }} {{ player_h.last_name }}  
                    </v-chip>
                  </v-list-tile-text> 
                </v-list-tile-content>
              </v-list-tile>
            ...
            <v-list subheader>
              ...
              <v-list-tile v-for="double_h in match.team_home.double" :key="double_h.id"  >
                <v-list-tile-content>
                  <v-list-tile-title>
          ...
          <v-flex xs6>
                ...
                <v-list-tile-content>
                  <v-list-tile-text>
                    <v-chip close closable outline>
                      ...
                      <v-avatar class="gray darken-4"><v-icon>check_circle</v-icon></v-avatar>{{ player_o.first_name }} {{ player_o.last_name }}  
                    </v-chip>
                  </v-list-tile-text> 
                </v-list-tile-content>
              </v-list-tile>
            ...
            <v-list subheader>
              <v-subheader inset>doubles</v-subheader>
              <v-list-tile v-for="double_o in match.team_opponent.double" :key="double_o.id"  >
                <v-list-tile-content>
                  <v-list-tile-title> {{ double_o.first_player.first_name  }} {{ double_o.first_player.last_name }} et {{ double_o.second_player.first_name }} {{ double_o.second_player.last_name }}</v-list-tile-title>
                </v-list-tile-content>
              </v-list-tile>
            </v-list>
          </v-flex>
